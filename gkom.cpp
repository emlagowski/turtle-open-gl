...
void displayObjects(int frame_no)
{
	...
	glRotatef( frame_no, 0.0, 1.0, 0.0 );
         ...
         glPushMatrix();
            ...
            glRotatef( 30.0, 1.0, 0.0, 0.0 );
			glRotatef( frame_no, 0.0, 0, 1.0 );
			glMaterialfv( GL_FRONT, GL_DIFFUSE, sphere_diffuse );
            glutSolidSphere( 1.0*0.5, 10, 10 );
         glPopMatrix();
	...
	glRotatef( -frame_no, 0.0, 1.0, 0.0 );
		 ...
		 glPushMatrix();
            ...
            glutSolidCube( 1.5 *0.5 );
         glPopMatrix();

         glPushMatrix();
            glTranslatef( 0.70, -0.90, 0.25 ); 
			glRotatef( 160.0, 1.0, 0.0, 0.0 );
			glRotatef( -10*frame_no, 0.0, 1.0, 0.0 );
            glMaterialfv( GL_FRONT, GL_DIFFUSE, octa_diffuse );
	        glutSolidTeapot( 1.0 *0.5);
         glPopMatrix();
	glPopMatrix();
...
void display()
{
	...
	glPushMatrix();
	glRotated(frame_no,0.0,1.0,0.0);
